                ...
                <div id="dashboard-menu-main"
                    ...
                    <div id="dashboard-menu-wrapper" className="w-full h-full min-h-full flex flex-col overflow-y-auto">
                        <div className="w-full flex-grow bg-black">
                            ...
                            >
                                <img src="/macropolis-logo.svg" alt="logo" className="h-10 invert"/>
                            ...
                            <div
                                className={`w-full pt-1 pb-1 pl-4 flex items-center text-md font-grotesk hover:cursor-pointer hover:text-green-300 ${isCurrentRoute('/dashboard') ? 'text-green-300' : 'text-white'}`}
                                onClick={() => redirectTo('/dashboard')}>Profile
                            </div>
                            <div
                                className={`w-full pt-1 pb-1 pl-4 flex items-center text-md font-grotesk hover:cursor-pointer hover:text-green-300  ${isCurrentRoute('/dashboard/items') ? 'text-green-300' : 'text-white'}`}
                                onClick={() => redirectTo('/dashboard/items')}>Items
                            </div>
                            <div
                                className={`w-full pt-1 pb-1 pl-4 flex items-center text-md font-grotesk hover:cursor-pointer hover:text-green-300  ${isCurrentRoute('/dashboard/collections') ? 'text-green-300' : 'text-white'}`}
                                onClick={() => redirectTo('/dashboard/collections')}>Collections
                            </div>
                            <div
                                className={`w-full pt-1 pb-1 pl-4 flex items-center text-md font-grotesk hover:cursor-pointer hover:text-green-300  ${isCurrentRoute('/dashboard/sales') ? 'text-green-300' : 'text-white'}`}
                                onClick={() => redirectTo('/dashboard/sales')}>Sales
                            </div>
                            <div
                                className={`w-full pt-1 pb-1 pl-4 flex items-center text-md font-grotesk hover:cursor-pointer hover:text-green-300  ${isCurrentRoute('/dashboard/withdrawals') ? 'text-green-300' : 'text-white'}`}
                                onClick={() => redirectTo('/dashboard/withdrawals')}>Withdrawals
                            </div>
                            <div
                                className={`w-full pt-1 pb-1 pl-4 flex items-center text-md font-grotesk hover:cursor-pointer hover:text-green-300  ${isCurrentRoute('/dashboard/nft') ? 'text-green-300' : 'text-white'}`}
                                onClick={() => redirectTo('/dashboard/nft')}>NFT
                            </div>
                        </div>
                        <div className="w-full bg-black">
                            <div
                                className={`w-full pt-1 pb-1 pl-4 flex items-center text-md font-grotesk hover:cursor-pointer hover:text-green-300 text-white`}
                                onClick={() => connectToMetamask()}><p className="truncate">{metamaskAccount ? metamaskAccount : 'Connect to Metamask'}</p>
                            </div>
                            <div
                                className={`w-full pt-1 pb-1 pl-4 flex items-center text-md font-grotesk hover:cursor-pointer hover:text-green-300 ${isCurrentRoute('/dashboard/plans') ? 'text-green-300' : 'text-white'}`}
