        ...
        <>
            ...
            <div className="w-screen h-screen relative">
                ...
                <div id="dashboard-menu-button"
                     className="lg:hidden absolute right-8 bottom-8 z-20 flex justify-center items-center border rounded-lg bg-black hover:cursor-pointer"
                     onClick={showMenu}
                >
                ...
                <div id="dashboard-menu-main"
                    ...
                    <div id="dashboard-menu-wrapper" className="w-full h-full min-h-full flex flex-col">
                        <div className="w-full flex-grow bg-black">
                            ...
                            <div
                                className={`w-full h-16 p-4 flex items-center text-2xl font-grotesk hover:cursor-pointer hover:text-green-300  ${isCurrentRoute('/dashboard/payments') ? 'text-green-300' : 'text-white'}`}
                                onClick={() => redirectTo('/dashboard/payments')}>payments
                            </div>
                        </div>
